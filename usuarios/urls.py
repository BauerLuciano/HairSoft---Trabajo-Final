...
urlpatterns = [
    ...
    path('api/generar-qr-temporal/', func_views.generar_qr_temporal, name='generar_qr_temporal'),
    path('api/check-pago-temporal/<uuid:uid>/', func_views.check_pago_temporal, name='check_pago_temporal'),
