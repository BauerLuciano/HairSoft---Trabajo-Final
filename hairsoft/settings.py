...
MERCADO_PAGO = {
    ...
    'WEBHOOK_URL': f"{TUNNEL_URL}/mercadopago/webhook/",
    'BINARY_MODE': True,
    'SANDBOX': True
}
...
GOOGLE_CLIENT_ID = "537753408019-uhdhpoqgkqtbkaj25d90601n1f3qguth.apps.googleusercontent.com"